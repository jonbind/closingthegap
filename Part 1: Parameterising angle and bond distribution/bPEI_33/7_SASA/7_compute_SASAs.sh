...
cd       AA
# Compute SASA
echo ${molecule} | gmx sasa -f ../../1_AA/3-run.xtc -s ../../1_AA/3-run.gro -ndots 4800 -probe 0.191  -o SASA-AA.xvg
...
echo ${molecule} | gmx trjconv -f ../1_AA/1-min.gro -o UNK-AA-min.gro -s ../1_AA/1-min.tpr -pbc whole
...
# Compute SASA
echo ${molecule} | gmx sasa -f ../../6_CGSIM/CG.xtc -s ../../6_CGSIM/CG.tpr -ndots 4800 -probe 0.191  -o SASA-CG.xvg -n ../../6_CGSIM/index.ndx
